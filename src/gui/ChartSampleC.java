...
//         if (analysis.size() > 2 && MainWindow.indexCounter == 2){
...
//             MainWindow.indexCounter = 0;
//             ChartPanel chartPanelSampleC = new ChartPanel(chart);
//             MainWindow.chartHolder.add(chartPanelSampleC, 2);
...
//         if(chart == null && analysis.size() > 2 && MainWindow.indexCounter == 2){
//             thisAnalysis = analysis.get(2);
//             if (title == null){
//                 analysis.remove(2);
...
//             ChartPanel chartPanelSampleC = new ChartPanel(chart);
//             MainWindow.chartHolder.remove(2);;
//             MainWindow frame = MainWindow.getInstance();
//             frame.setVisible(true);
//         }
